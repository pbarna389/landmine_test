...
export default function Carousel() {
	...
	return (
		...
		>
			...
			/>
			<div className="absolute z-5 top-3/8 left-1/2 space-y-10 text-center gap-15 transform -translate-1/2 md:translate-0 md:text-left md:top-[29.6%] md:left-1/15 text-5xl font-montserrat font-bold leading-13 transition-all">
				<div>
