	...
	return (
		<>
			<div ref={ref}>
				...
				<nav
					className={`fixed flex flex-col overflow-scroll items-center border-l-2 border-r-2 border-t-0 border-b-0  border-white/98 z-2 top-8 right-0 min-h-screen h-full sm:w-[calc(100vw*0.7)] bg-white/98 origin-right transition opacity-97 *:brightness-115 ${isOpen ? 'scale-x-100' : 'scale-x-0'}`}
				>
