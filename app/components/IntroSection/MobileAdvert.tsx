...
export const MobileAdvert = () => {
	...
	return (
		<div className="flex flex-col gap-3 items-center justify-center mt-15 font-montserrat bg-introMobileAdvertBg border-t-sectionHeader border-t border-b-sectionHeader border-b w-[calc(100vw*0.8)] min-w-42.5 min-h-37.5">
			<div
